...
class EmptyWorkoutPage extends StatefulWidget {
  @override
  _EmptyWorkoutPageState createState() => _EmptyWorkoutPageState();
}

class _EmptyWorkoutPageState extends State<EmptyWorkoutPage> {
      ...
      builder: (BuildContext context) {
        return AlertDialog(
          ...
          content: Column(
            ...
            children: [
              Text('Are you sure you want to finish your workout?', style: TextStyle(color: Colors.white70)),
              SizedBox(height: 16),
              TextField(
  ...
  void _showDiscardConfirmationDialog() {
    showDialog(
      ...
      builder: (BuildContext context) {
        return AlertDialog(
          backgroundColor: const Color.fromARGB(255, 19, 19, 19),
          title: Text('Discard Workout', style: TextStyle(color: Colors.white)),
          content: Text('Are you sure you want to discard your workout? This action cannot be undone.', style: TextStyle(color: Colors.white70)),
          actions: <Widget>[
            TextButton(
              child: Text('Cancel', style: TextStyle(color: Color(0xFFFF8000))),
              onPressed: () {
              ...
              child: SingleChildScrollView(
                child: Column(
                  ...
                  children: [
                    ...
                    SizedBox(height: 8),
                    Text(
                      'Add an exercise or routine to start your workout',
